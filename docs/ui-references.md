...
Newest sweep first. Earlier sweeps are kept below — they are still the provenance for
the surfaces they were mined for, and they record which references were already
rejected and why.

## Crew portal — mined 2026-09-17 · bottom tab bar + week strip
