...
import {
  LayoutDashboard, Briefcase, Users, CalendarDays, MapPin,
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between px-3 py-3 border-b border-border shrink-0">
          <Link href="/crm" onClick={() => window.innerWidth < 768 && setOpen(false)}>
            <svg viewBox="0 0 280 112" className="h-9 w-auto" role="img" aria-label="Dr. Squeegee">
              ...
              <text x="140" y="74" textAnchor="middle" style={{ fontFamily: "var(--font-brand-display), 'Oswald', Impact, sans-serif", letterSpacing: "2px" }} fontWeight="700" fontSize="40" fill="#FFFFFF">DR. SQUEEGEE</text>
            </svg>
          </Link>
          <button
            onClick={() => setOpen(false)}
