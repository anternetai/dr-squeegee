...
import {
  ...
  MessageSquareHeart, Sparkles, Sun, Moon, LogOut, Menu, X, FileText, DoorOpen, HardHat, Gauge,
} from "lucide-react"
import { cn } from "@/lib/utils"

const NAV = [
  { label: "Dashboard",  href: "/crm",             icon: LayoutDashboard },
  { label: "Command",    href: "/crm/ops",          icon: Gauge },
  ...
  { label: "Team",       href: "/crm/team",         icon: HardHat },
